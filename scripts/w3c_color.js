/**
 * Generate const skia colors code for cpp
 */
...
const w3cExtedendColorCpp = lines.reduce((result, line) => {
...
fs.writeFileSync('temp_w3c_extedend_color_cpp', w3cExtedendColorCpp)
